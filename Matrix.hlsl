...
static const uint GLYPHS[16] = {
    ((10u<<30)|(4u<<25)|(4u<<20)|(10u<<15)|(17u<<10)|(17u<<5)|14u),   // ア style
    ((16u<<30)|(8u<<25)|(4u<<20)|(2u<<15)|(1u<<10)|(4u<<5)|4u),       // イ style
    ((14u<<30)|(17u<<25)|(17u<<20)|(16u<<15)|(16u<<10)|(16u<<5)|31u), // ウ style
    ((31u<<30)|(4u<<25)|(4u<<20)|(4u<<15)|(4u<<10)|(4u<<5)|31u),      // エ style
...
float3 DrawLayer(float2 uv, float depth, float speed_mult, float brightness, float seed_shift) {
    ...
    // Get pixel from glyph bitmap (5x7 resolution)
    // Add border padding
